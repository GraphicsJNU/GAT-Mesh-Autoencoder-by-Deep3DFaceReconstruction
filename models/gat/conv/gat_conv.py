...
class GATConv(MessagePassing):
    ...
    def forward(self, x: Tensor, edge_index: Adj,
                ...
                **kwargs):
        # type: (Union[Tensor, OptPairTensor], Tensor, OptTensor, NoneType) -> Tensor  # noqa
        # type: (Union[Tensor, OptPairTensor], SparseTensor, OptTensor, NoneType) -> Tensor  # noqa
        # type: (Union[Tensor, OptPairTensor], Tensor, OptTensor, bool) -> Tuple[Tensor, Tuple[Tensor, Tensor]]  # noqa
        # type: (Union[Tensor, OptPairTensor], SparseTensor, OptTensor, bool) -> Tuple[Tensor, SparseTensor]  # noqa
        r"""
        Args:
        ...
        alpha = (alpha_src.permute(1, 2, 0), alpha_dst.permute(1, 2, 0))
        ...
        if self.add_self_loops:
            if isinstance(edge_index, Tensor):
                ...
                # edge_attr[edge_attr == float('inf')] = 0
        ...
        if self.concat:
            out = out.view(num_batches, num_nodes, self.heads * self.out_channels)
        else:
            out = out.mean(2)
